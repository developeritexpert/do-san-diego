...
document.addEventListener('DOMContentLoaded', () => {
    ...
    (function initStaySlider() {
        ...
        const originalCards = Array.from(stayTrack.querySelectorAll('.stay-card-item'));
    ...
    // Open: wire up any button with data-toggle="slide-left" to its data-target
    document.querySelectorAll('[data-toggle="slide-left"]').forEach(function (toggler) {
    ...
    document.querySelectorAll('.slide-close-button button, .bg-overlay, .close-btn-cont')
        ...
        submenuTogglers.forEach((toggler) => {
            toggler.addEventListener('click', function () {
                ...
                submenuTogglers.forEach((otherToggler) => {
                    ...
                    if (otherSubmenu && otherSubmenu.classList.contains('sub-menu-cont')) {
